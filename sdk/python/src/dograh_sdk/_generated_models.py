...
#   filename:  dograh-openapi-VR18xB.json
#   timestamp: 2026-09-18T16:53:23+00:00
...
class HybridTurnConfiguration(BaseModel):
    ...
    wait_ms: Annotated[int | None, Field(ge=0, le=2000, title='Wait Ms')] = 0
    """
    ...
    """
    hold_ms: Annotated[int | None, Field(ge=0, le=10000, title='Hold Ms')] = 1500
    """
...
class LLMScope(BaseModel):
    ...
    inference: Annotated[bool | None, Field(title='Inference')] = False
    extraction: Annotated[bool | None, Field(title='Extraction')] = False
    voicemail: Annotated[bool | None, Field(title='Voicemail')] = False
    filler: Annotated[bool | None, Field(title='Filler')] = False
...
class ProviderTuning(BaseModel):
    ...
    ctor: Annotated[dict[str, Any] | None, Field(title='Ctor')] = None
...
class ServiceTuning(BaseModel):
    ...
    stt: Annotated[dict[str, ProviderTuning] | None, Field(title='Stt')] = None
    tts: Annotated[dict[str, ProviderTuning] | None, Field(title='Tts')] = None
    llm: Annotated[dict[str, ProviderTuning] | None, Field(title='Llm')] = None
    realtime: Annotated[dict[str, ProviderTuning] | None, Field(title='Realtime')] = (
        None
    )
    scope: LLMScope | None = None
...
class TranscriptConfiguration(BaseModel):
    ...
    include_end_timestamps: Annotated[
        bool | None, Field(title='Include End Timestamps')
    ] = False
...
class TurnConfiguration(BaseModel):
    ...
    source: Annotated[Source | None, Field(title='Source')] = 'auto'
    hybrid: HybridTurnConfiguration | None = None
...
class UserTurnStopTimeout(RootModel[float]):
    root: Annotated[float, Field(gt=0.0, title='User Turn Stop Timeout')]
...
class WorkflowConfigurationDefaults(BaseModel):
    ...
    voicemail_detection: VoicemailDetectionConfiguration | None = None
    transcript_configuration: TranscriptConfiguration | None = None
    service_tuning: ServiceTuning | None = None
    """
    ...
    user_turn_stop_timeout: Annotated[
        UserTurnStopTimeout | None, Field(title='User Turn Stop Timeout')
    ] = None
    ...
    model_overrides: Annotated[
        dict[str, Any] | None, Field(title='Model Overrides')
    ] = None
    model_configuration_v2_override: Annotated[
        dict[str, Any] | None, Field(title='Model Configuration V2 Override')
    ] = None
    call_dispositions_extend_org: Annotated[
        bool | None, Field(title='Call Dispositions Extend Org')
    ] = False
